...
#set(CORE_FLAGS "${CORE_FLAGS} -mfloat-abi=hard -mfpu=fpv4-sp-d16 -ffast-math")				# The device does not have an FPU
...
set(CXX_FLAGS "-std=gnu++14 -fno-rtti -fno-exceptions -fverbose-asm -MMD -g -DDEBUG")
...
# fverbose-asm - additional comments for generated assembler code
# -MMD - create dependency files
set(C_FLAGS "-std=gnu89 -ffunction-sections -fdata-sections -fverbose-asm -MMD -g -DDEBUG")

set(ASM_FLAGS "-x assembler-with-cpp -g -DDEBUG")
...
set(LD_FLAGS "-Wl,-Map=${PROJECT_BINARY_DIR}/${CMAKE_PROJECT_NAME}.map,--cref -T${LD_SCRIPT} -Wl,--gc-sections -g -DDEBUG")
